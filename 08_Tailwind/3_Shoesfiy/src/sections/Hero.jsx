    ...
    <section
      ...
      className="w-full flex xl:flex-row flex-col justify-center gap-10 max-container min-h-screen">
        <div className="relative
          ...
          <h1 className="mt-10 
            font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82] font-bold">
          ...
          <p className="font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-md">
            From Street to Chic, Versatile Footwear That Transitions Seamlessly from Day to Night
          </p>
